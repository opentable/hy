...
// testFileTargets is a set of fileTargets that will round-trip to files,
// strongly-typed Go values, and back unchanged, since it has all keys
// set.
// This is in contrast to testFileTargetsUnsetKeys which will have its keys
// set on both read and write, according to field tags.
var testFileTargets = MustNewFileTargets([]*FileTarget{
	{FilePath: "",
	...
	{FilePath: "nested/map-of-ptr/a-nil-file",
		Value: map[string]interface{}{
			"Name": "a-nil-file", // auto-set key
			//"FileSubStruct": nil,
			//"DirSubMap":     nil,
		}},
	{FilePath: "nested/map-of-ptr/another-nil-file",
		Value: map[string]interface{}{
			"Name": "another-nil-file", // auto-set key
			//"FileSubStruct": nil,
			//"DirSubMap":     nil,
		}},
...
var testFileTargetsUnsetKeys = MustNewFileTargets([]*FileTarget{
	{FilePath: "",
		Value: map[string]interface{}{
			"Name":        "Test struct writing",
			"Int":         1,
...
var (
	testFileTargetsSnapshot          = testFileTargets.Snapshot()
	testFileTargetsUnsetKeysSnapshot = testFileTargetsUnsetKeys.Snapshot()
)
